            ...
            <Card className="relative w-full max-w-sm overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-xl">
                ...
                <CardContent className="relative pt-0">
                    <form id="form-rhf-demo" onSubmit={form.handleSubmit(onSubmit)}>
                                    ...
                                    <Field data-invalid={fieldState.invalid} className="relative">
                                        ...
                                        <div className="relative">
                                            <Input
                                                ...
                                                focus:ring-2 focus:ring-violet-200 focus:border-violet-300 placeholder:text-zinc-400"
                                    ...
                                    <Field data-invalid={fieldState.invalid} className="relative">
                                        ...
                                        <div className="relative">
                                            <Input
                                                ...
                                                type="password"
                                                className="h-12 pl-10 rounded-xl border border-zinc-200 bg-zinc-50 
                                                focus:ring-2 focus:ring-blue-200 focus:border-blue-300 placeholder:text-zinc-400"
                        ...
                        <div className="text-right mt-1 mb-4">
                            <Link href="/forgot" className="text-sm text-zinc-600 hover:text-zinc-900 underline underline-offset-4">
                                Forgot Password?
                            </Link>
                        </div>
                    </form>
                ...
                <CardFooter className="relative flex flex-col gap-3 pb-6 pt-0">
                    <Button
                        ...
                        type="submit"
                        form="form-rhf-demo"
                        className="w-full h-12 rounded-xlbg-slate-900 text-white font-semibold hover:bg-slate-800
