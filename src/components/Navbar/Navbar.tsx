...
import logo from "../../app/freshmart.png"
                    ...
                    <Link href="/" className="group">
                        <div className="flex items-center gap-3 shrink-0">
                            <div className="rounded-2xl bg-slate-900 ring-1 ring-slate-800 p-1.5 shadow-sm transition-all duration-300 group-hover:bg-slate-900/80 group-hover:ring-slate-700">
                                <Image src={logo} alt="Logo" width={26} height={26} className="rounded-xl" />
                            </div>
                            <span
                                className={[
                                    poppins.className,
                                    "text-base sm:text-lg font-bold tracking-tight",
                                    "bg-linear-to-r from-blue-400 via-violet-400 to-purple-500 bg-clip-text text-transparent",
                                ].join(" ")}
                            >
                                FreshMart
                            </span>
                                ...
                                <NavigationMenuItem key={tab}>
                                    <NavigationMenuLink asChild>
                                        <Link
                                            ...
                                            after:bg-linear-to-r after:from-blue-500 after:via-violet-500 after:to-purple-500 after:transition-transform after:duration-300
