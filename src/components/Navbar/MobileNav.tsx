          ...
          ${open ? "translate-x-0" : "-translate-x-full"}`}
                >
                    ...
                    <div className="flex items-center justify-between p-5 border-b border-slate-800">
                        <span className="text-lg font-bold bg-linear-to-r from-blue-400 via-violet-400 to-purple-500 bg-clip-text text-transparent">
                            Menu
                        </span>
                        <button
                            onClick={() => setOpen(false)}
              ...
              hover:bg-slate-800 transition"
                ...
                transition-all duration-300 hover:bg-slate-800/70 hover:text-white"
                            >
                                <span>{tab}</span>
              ...
              hover:bg-slate-800/60 hover:text-white transition"
                        >
                            Home
                        </Link>
                    </div>
