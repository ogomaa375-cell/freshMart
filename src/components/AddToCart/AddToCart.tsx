  ...
  return (
    <CardFooter className="gap-2 p-0 mt-0">
      <Button
        ...
        className="flex-1 h-11 rounded-xl bg-slate-900 text-white font-semibold flex items-center justify-center gap-2
        shadow-sm transition-all duration-300 hover:bg-slate-800 hover:shadow-md active:scale-[0.98]
        disabled:opacity-70 disabled:cursor-not-allowed border border-slate-800 hover:ring-2 hover:ring-slate-900/20">
        {isLoading ? (
      ...
      <button
        ...
        className="grid size-11 place-items-center rounded-xl border border-zinc-200 bg-white shadow-sm
        transition-all duration-300 hover:bg-zinc-50 hover:shadow-md active:scale-[0.95]
        ...
        {wishLoading ? (
          ...
          <HeartIcon
            className={
              inWishlist ? "size-5 text-red-500 fill-red-500" : "size-5 text-zinc-700"
            }/>
        )}
      </button>
    </CardFooter>
