...
const session = await getServerSession(authOptions);
  ...
  <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
    ...
    <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-indigo-400/20 blur-[120px] rounded-full" />
    <div className="pointer-events-none absolute bottom-0 right-0 w-[600px] h-[400px] bg-violet-400/20 blur-[120px] rounded-full" />
    ...
    <div className="relative max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-6 sm:p-8 shadow-sm">
        ...
        <div className="relative text-center space-y-3">
          ...
          <div className="mx-auto mt-4 h-1 w-24 rounded-full bg-linear-to-r from-blue-600 to-violet-600" />
        </div>
      </div>
